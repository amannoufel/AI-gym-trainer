...
def gym(choice):
    ...
    # Add more helpful print messages if needed
    ...
    if choice == 0:
        ...
        second = 13  # left elbow
        third = 15   # left wrist
        down_threshold = 160  # angle when arms are down
        up_threshold = 90    # angle when arms are up
        stage_type = 1      # 1 means up/down movement
        exercise = 'Bench press'
        fourth = 12  # right shoulder
        fifth = 14   # right elbow
        sixth = 16   # right wrist
    elif choice == 5:  # Move the exit condition to choice 5
        exit()
